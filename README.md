...
如果你的目标是强化学习岗位面试，建议先看[强化学习岗位面试路线](web/docs/interview/index.md)：它把 MDP、贝尔曼方程、Q 学习、DQN、PPO、SAC、离线强化学习、模仿学习、RLHF 和工程调试整理成 15 个高价值问答，并映射到对应章节、公式手算和常见追问。

## ✨ 主要功能

- **22 课独立页面**（第 0 课 + 第 1—21 课），带侧边栏、本页目录、全文搜索和前后课导航。
- **每课完整学习闭环**：学习目标、前置知识、直觉类比、结构图解、公式拆解、可运行代码、常见误区、动手练习、自测和小结。
- **面试备战索引**：独立页面整理强化学习岗位常问方向、八股式追问、项目表达模板和 7 天复习计划。
...
- 强化学习岗位面试路线：15 个高价值问题、课程映射、7 天复习计划、项目表达模板
